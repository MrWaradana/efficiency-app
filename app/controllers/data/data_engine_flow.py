    ...
    def get_all_engine_flow_data(self, data_id):
        ...
        def fetch_data(data_id):
            ...
            return {
                ...
                'HPT': ((results.get(variables[1]) * results.get(variables[2]) * results.get(variables[2]))/(100*100*100)), #% 
                'IPT': ((results.get(variables[4]) * results.get(variables[5]))/(100*100)), #%
                'LPT': ((results.get(variables[6]) * results.get(variables[7]) * results.get(variables[8]) * results.get(variables[9]))/(100*100*100*100)),
