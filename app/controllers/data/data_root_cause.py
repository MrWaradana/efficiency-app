...
class DataDetailRootCauseController(BaseController[EfficiencyDataDetailRootCause]):
    ...
    def check_root_cause(self, data_id):
        ...
        # variable_causes_count = dict(variable_cause_repository.get_by_variable_ids(list(data_details.keys())))
        ...
        for data_detail_id, var_id, is_repair, is_checked, variable_cause_name , variable_cause_id, variable_cause_parent_id in root_cause_count:
            if not is_checked:
                continue
